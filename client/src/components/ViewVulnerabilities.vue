        ...
        <div>
          <v-alert color="red" elevation="24" type="error"
            ><v-row align="center">
              ...
              <v-col class="shrink">
                <v-btn to="/keywords">Go back</v-btn>
              </v-col>
            </v-row></v-alert
          >
        </div>
      </slot>
<v-simple-table fixed-header height="600px" width="5000px" v-if="!loading && totalresults !== 0">
  <template v-slot:default>
    ...
    <tbody>
      ...
      <slot name="footer" v-if="!loading && !loading2">
